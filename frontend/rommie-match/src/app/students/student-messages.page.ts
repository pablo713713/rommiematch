...
@Component({
  ...
  template: `
    <h3 class="text-2xl font-semibold text-pastel-blue mb-4">Mis mensajes</h3>

    <p *ngIf="!isStudent" class="text-red-600">
      Solo los estudiantes tienen bandeja de entrada aquí.
    </p>
...
export default class StudentMessagesPage {
  ...
  responder(m: Message) {
    this.router.navigate(
      ['/students/messages/compose', m.senderId],
      {
        queryParams: {
          name: m.senderName,
